...
describe('hyperlane warp deploy e2e tests', async function () {
  ...
  describe(`hyperlane warp deploy --config ... --yes --key ...`, () => {
    ...
    // NOTE: This test is disabled because it is failing and unrelated to the Fuel side
    // And later commits on the official monorepo does not have this test case
