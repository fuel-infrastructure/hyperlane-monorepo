...
const abi = {
  ...
  concreteTypes: [
    ...
    {
      type: 'enum DomainRoutingIsmError',
      concreteTypeId:
        'd6a68e63771bcc70200ac9382eacbf6434843d6e1d95b91d3d4752aaa277bb50',
      metadataTypeId: 1,
    },
    {
  ...
  functions: [
    ...
    },
    {
      ...
      attributes: [
        {
          name: 'doc-comment',
          arguments: [' Sets the owner of the ISM.'],
        },
        {
          name: 'doc-comment',
          arguments: [''],
...
export class DomainRoutingIsm extends Contract {
  ...
  declare functions: {
    ...
    initialize_with_domains: InvokeFunction<
      [owner: string, domains: Vec<BigNumberish>, modules: Vec<string>],
      void
    >;
