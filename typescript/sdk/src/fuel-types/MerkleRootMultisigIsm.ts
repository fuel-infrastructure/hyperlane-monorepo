...
export type MerkleRootMultisigIsmConfigurables = Partial<{
  ...
  functions: [
    ...
    },
    {
      ...
      attributes: [
        ...
        {
          name: 'doc-comment',
          arguments: [' * If the message index and signed index do not match.'],
        },
        {
          name: 'doc-comment',
          arguments: [' * If data passed in is invalid.'],
        },
      ],
    },
    {
...
export class MerkleRootMultisigIsmInterface extends Interface {
  constructor() {
    super(abi);
  }
...
export class MerkleRootMultisigIsm extends __Contract {
  static readonly abi = abi;
  static readonly storageSlots = storageSlots;

  declare interface: MerkleRootMultisigIsmInterface;
  declare functions: {
