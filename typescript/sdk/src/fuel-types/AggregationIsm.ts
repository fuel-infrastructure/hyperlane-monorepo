...
export enum AggregationIsmErrorInput {
  DidNotMeetThreshold = 'DidNotMeetThreshold',
  AlreadyInitialized = 'AlreadyInitialized',
  NotInitialized = 'NotInitialized',
}
export enum AggregationIsmErrorOutput {
  DidNotMeetThreshold = 'DidNotMeetThreshold',
  AlreadyInitialized = 'AlreadyInitialized',
  NotInitialized = 'NotInitialized',
}
...
const abi = {
  ...
  concreteTypes: [
    ...
    },
    {
      ...
      concreteTypeId:
        '338f8824eff0cecf524266f2ab1e824b639f96afdeef1cbd5b1c66f9f50bb70e',
      metadataTypeId: 0,
    },
    {
      type: 'b256',
  ...
  functions: [
    ...
    },
    {
      ...
      attributes: [
        ...
        {
          name: 'doc-comment',
          arguments: [' * If the verifications do not meet the threshold.'],
        },
        {
          name: 'storage',
          arguments: ['read'],
    ...
    },
    {
      ...
      attributes: [
        {
          name: 'doc-comment',
          arguments: [' Enrolls a module to the Aggregation ISM.'],
        },
        {
          name: 'doc-comment',
          arguments: [''],
    ...
    },
    {
      ...
      attributes: [
        {
          name: 'doc-comment',
          arguments: [' Sets the threshold for the Aggregation ISM.'],
        },
        {
          name: 'doc-comment',
          arguments: [''],
...
export class AggregationIsmInterface extends Interface {
  ...
  declare functions: {
    ...
    enroll_module: FunctionFragment;
...
export class AggregationIsm extends Contract {
  ...
  declare functions: {
    ...
    modules_and_threshold: InvokeFunction<
      [message: Bytes],
      [Vec<ContractIdOutput>, number]
    >;
    enroll_module: InvokeFunction<[module: ContractIdInput], void>;
    initialize: InvokeFunction<[owner: string], void>;
