...
const abi = {
  ...
  concreteTypes: [
    ...
    {
      type: 'enum DefaultFallbackDomainRoutingIsmError',
      concreteTypeId:
        '5ad8eff898b23a7d9ffb82a008e83a88fa07efa70498cbadea9ac808c48084ec',
      metadataTypeId: 1,
    },
    {
  ...
  functions: [
    ...
    },
    {
      ...
      attributes: [
        ...
        {
          name: 'doc-comment',
          arguments: [' * `owner`: [b256] - The address of the owner.'],
        },
        {
          name: 'doc-comment',
...
export class DefaultFallbackDomainRoutingIsm extends Contract {
  ...
  declare functions: {
    ...
    initialize: InvokeFunction<[owner: string, mailbox: string], void>;
