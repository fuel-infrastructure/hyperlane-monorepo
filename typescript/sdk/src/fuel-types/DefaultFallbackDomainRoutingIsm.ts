...
export type DefaultFallbackDomainRoutingIsmErrorInput = Enum<{
  DomainModuleLengthMismatch: [];
  DomainNotSet: BigNumberish;
}>;
export type DefaultFallbackDomainRoutingIsmErrorOutput = Enum<{
  DomainModuleLengthMismatch: [];
  DomainNotSet: number;
}>;
...
export type DefaultFallbackDomainRoutingIsmConfigurables = Partial<{
...
const abi = {
  ...
  concreteTypes: [
    ...
    {
      type: 'enum interfaces::isms::routing::default_fallback_domain_routing_ism::DefaultFallbackDomainRoutingIsmError',
      concreteTypeId:
        'f417349370c05301429c43a092123f2c779795b031cda28952bc772aa336c228',
      metadataTypeId: 2,
    },
    {
  ...
  functions: [
    ...
    },
    {
      ...
      attributes: [
        {
          name: 'doc-comment',
          arguments: [' Sets the owner and mailbox of the ISM.'],
        },
        {
          name: 'doc-comment',
          arguments: [''],
        ...
        {
          name: 'doc-comment',
          arguments: [' * `mailbox`: [b256] - The address of the mailbox.'],
        },
        {
          name: 'doc-comment',
          arguments: [''],
    ...
    },
    {
      ...
      attributes: [
        {
          name: 'doc-comment',
          arguments: [' Returns the fallback mailbox for the ISM'],
        },
        {
          name: 'doc-comment',
          arguments: [''],
        ...
        {
          name: 'doc-comment',
          arguments: [' * [b256] - The address of the mailbox.'],
        },
        {
          name: 'storage',
          arguments: ['read'],
...
export class DefaultFallbackDomainRoutingIsmInterface extends Interface {
  constructor() {
    super(abi);
  }
...
export class DefaultFallbackDomainRoutingIsm extends __Contract {
  static readonly abi = abi;
  static readonly storageSlots = storageSlots;

  declare interface: DefaultFallbackDomainRoutingIsmInterface;
  declare functions: {
    ...
    initialize: InvokeFunction<[owner: IdentityInput, mailbox: string], void>;
    initialize_with_domains: InvokeFunction<
      [
        owner: IdentityInput,
        mailbox: string,
        domains: Vec<BigNumberish>,
        modules: Vec<string>,
      ],
      void
    >;
    mailbox: InvokeFunction<[], string>;
